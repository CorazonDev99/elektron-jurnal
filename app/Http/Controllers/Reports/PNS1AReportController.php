...
class PNS1AReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reports.pns1a.index', compact('roleId', 'months', 'completed', 'inProgress', 'notCompleted', 'total', 'viewMode'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        $query = DB::table('pns1a')
            ->select(
                ...
                'pns1a.solution',
                'pns1a.resolved',
                'pns1a.responsible_person',
                'pns1a.deadline',
                DB::raw("DATE_FORMAT(pns1a.created_at, '%d-%m-%Y %H:%i') AS created_at"),
                DB::raw("DATE_FORMAT(pns1a.updated_at, '%d-%m-%Y %H:%i') AS updated_at"),
            ...
            ->whereMonth('pns1a.created_at', '=', date('n', strtotime($month)))
            ->whereYear('pns1a.created_at', '=', now()->year)
            ->groupBy('pns1a.id', 'pns1a.employee_name', 'pns1a.equipment', 'pns1a.problem', 'pns1a.solution', 'pns1a.responsible_person', 'pns1a.deadline', 'pns1a.created_at', 'pns1a.updated_at');

...
class PNS2AReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reports.pns2a.index', compact('roleId', 'months', 'completed', 'inProgress', 'notCompleted', 'total', 'viewMode'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        $query = DB::table('pns2a')
            ->select(
                ...
                'pns2a.solution',
                'pns2a.resolved',
                'pns2a.responsible_person',
                'pns2a.deadline',
                DB::raw("DATE_FORMAT(pns2a.created_at, '%d-%m-%Y %H:%i') AS created_at"),
                DB::raw("DATE_FORMAT(pns2a.updated_at, '%d-%m-%Y %H:%i') AS updated_at"),
            ...
            ->whereMonth('pns2a.created_at', '=', date('n', strtotime($month)))
            ->whereYear('pns2a.created_at', '=', now()->year)
            ->groupBy('pns2a.id', 'pns2a.employee_name', 'pns2a.equipment', 'pns2a.problem', 'pns2a.solution', 'pns2a.responsible_person', 'pns2a.deadline', 'pns2a.created_at', 'pns2a.updated_at');

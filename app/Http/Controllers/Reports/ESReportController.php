...
class ESReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reports.ec.index', compact('roleId', 'months', 'completed', 'inProgress', 'notCompleted', 'total', 'viewMode'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        $query = DB::table('ec')
            ->select(
                ...
                'ec.solution',
                'ec.resolved',
                'ec.responsible_person',
                'ec.deadline',
                DB::raw("DATE_FORMAT(ec.created_at, '%d-%m-%Y %H:%i') AS created_at"),
                DB::raw("DATE_FORMAT(ec.updated_at, '%d-%m-%Y %H:%i') AS updated_at"),
            ...
            ->whereMonth('ec.created_at', '=', date('n', strtotime($month)))
            ->whereYear('ec.created_at', '=', now()->year)
            ->groupBy('ec.id', 'ec.employee_name', 'ec.equipment', 'ec.problem', 'ec.solution', 'ec.responsible_person', 'ec.deadline', 'ec.created_at', 'ec.updated_at');

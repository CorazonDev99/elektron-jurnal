...
class ESController extends Controller
{
    ...
    public function deleteRecord(Request $request)
    {
        ...
        try {
            ...
            \DB::table('ec')->whereIn('id', $ids)->delete();
    ...
    public function getData(Request $request)
    {
        ...
        $d->selectRaw("'' as `empty`, ec.id,ec.user_id, ec.role_id, DATE_FORMAT(ec.created_at, '%d-%m-%Y %H:%i') AS created_at,
                ...
                ec.responsible_person, DATE_FORMAT(ec.deadline, '%d-%m-%Y') AS deadline, ec.acknowledgment, ec.resolved, ec.reason, ec.employee_name");
        ...
        if ($request->filled('acknowledgment')) {
            $d->where('ec.acknowledgment', $request->acknowledgment);
        }

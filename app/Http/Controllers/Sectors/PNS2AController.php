...
class PNS2AController extends Controller
{
    ...
    {
        $userId = auth()->id();
        $roleId = \DB::table('pns2a')->where('id', $userId)->select('role_id')->first();
    ...
    public function getData(Request $request)
    {
        ...
        $d->selectRaw("'' as `empty`, pns2a.id,pns2a.user_id, pns2a.role_id, DATE_FORMAT(pns2a.created_at, '%d-%m-%Y %H:%i') AS created_at,
                ...
                pns2a.responsible_person, DATE_FORMAT(pns2a.deadline, '%Y-%m-%d') AS deadline, pns2a.acknowledgment, pns2a.resolved, pns2a.employee_name");

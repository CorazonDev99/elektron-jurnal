...
@section('script')
    ...
    <script>
        ...
        var options = {
            ...
            title: {
                text: 'Реагент участкаси бойича аникланган камчиликлар сони',
                align: 'center'
            },
            tooltip: {
                y: {
        ...
        var fp = flatpickr("#period-picker", {
            ...
            onClose: function (selectedDates) {
                if (selectedDates.length === 2) {
                    ...
                    $.ajax({
                        url: '/get-report-by-period-reagent',
                        type: "POST",
                        data: {
...
@section('header_title', 'Реагент участкаси бойича Хисоботлар')

...
@section('script')
    ...
    <script>
        ...
        var options = {
            ...
            title: {
                text: 'УЧАСТОК №1 бойича аникланган камчиликлар сони',
                align: 'center'
            },
            tooltip: {
                y: {
        ...
        var fp = flatpickr("#period-picker", {
            ...
            onClose: function (selectedDates) {
                if (selectedDates.length === 2) {
                    ...
                    $.ajax({
                        url: '/get-report-by-period-sector1',
                        type: "POST",
                        data: {
                        ...
                        success: function (response) {
                            ...
                            <p>Бажарилган камчиликлар: ${response.completed}</p>
...
@section('header_title', 'УЧАСТОК №1 бойича Хисоботлар')

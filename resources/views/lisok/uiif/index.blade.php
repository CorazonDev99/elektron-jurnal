        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'uiif.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'uiif.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'uiif.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'uiif.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'uiif.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'uiif.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'uiif.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'uiif.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'uiif.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('uiif.updateAcknowledgment') }}',
                            type: 'POST',

        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'udii.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'udii.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'udii.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'udii.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'udii.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'udii.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'udii.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'udii.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'udii.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('udii.updateAcknowledgment') }}',
                            type: 'POST',

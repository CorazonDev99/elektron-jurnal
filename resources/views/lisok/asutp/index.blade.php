        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'asutp.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'asutp.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'asutp.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'asutp.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'asutp.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'asutp.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'asutp.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'asutp.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'asutp.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('asutp.updateAcknowledgment') }}',
                            type: 'POST',

        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'pns2a.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'pns2a.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'pns2a.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'pns2a.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'pns2a.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'pns2a.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'pns2a.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'pns2a.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'pns2a.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('pns2a.updateAcknowledgment') }}',
                            type: 'POST',

        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'user_id', name: 'ec.user_id', searchable: false, visible: false},
                    ...
                    {data: 'reason', name: 'ec.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('ec.updateAcknowledgment') }}',
                            type: 'POST',

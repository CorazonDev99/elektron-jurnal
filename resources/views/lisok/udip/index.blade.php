        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'udip.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'udip.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'udip.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'udip.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'udip.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'udip.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'udip.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'udip.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'udip.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('udip.updateAcknowledgment') }}',
                            type: 'POST',

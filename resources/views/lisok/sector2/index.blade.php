        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'sector2.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'sector2.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'sector2.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'sector2.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'sector2.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'sector2.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'sector2.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'sector2.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'sector2.reason', sClass: 'dt-center'},
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '{{route('sector2.reasonRecord')}}',
                                    type: 'POST',
                                    data: formData,
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('sector2.updateAcknowledgment') }}',
                            type: 'POST',
        ...
        $('#deleteButton').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let bronNum = 0
                    $.ajax({
                        url: "{{ route('sector2.deleteRecord') }}",
                        type: 'DELETE',
                        data: {
                            ids: ids,
                            _token: $('meta[name="csrf-token"]').attr('content')
...
@endsection
@section('header_title', 'Участок №2')

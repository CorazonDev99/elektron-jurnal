        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'reagent.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'reagent.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'reagent.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'reagent.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'reagent.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'reagent.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'reagent.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'reagent.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'reagent.reason', sClass: 'dt-center'},
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '{{route('reagent.reasonRecord')}}',
                                    type: 'POST',
                                    data: formData,
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('reagent.updateAcknowledgment') }}',
                            type: 'POST',
        ...
        $('#deleteButton').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let bronNum = 0
                    $.ajax({
                        url: "{{ route('reagent.deleteRecord') }}",
                        type: 'DELETE',
                        data: {
                            ids: ids,
                            _token: $('meta[name="csrf-token"]').attr('content')
...
@endsection
@section('header_title', 'Участок по приготовление реагентов')

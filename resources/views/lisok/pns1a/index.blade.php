        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'pns1a.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'pns1a.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'pns1a.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'pns1a.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'pns1a.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'pns1a.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'pns1a.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'pns1a.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'pns1a.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('pns1a.updateAcknowledgment') }}',
                            type: 'POST',

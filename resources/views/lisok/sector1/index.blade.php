        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'sector1.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'sector1.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'sector1.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'sector1.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'sector1.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'sector1.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'sector1.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'sector1.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'sector1.reason', sClass: 'dt-center'},
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '{{route('sector1.reasonRecord')}}',
                                    type: 'POST',
                                    data: formData,
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('sector1.updateAcknowledgment') }}',
                            type: 'POST',
        ...
        $('#deleteButton').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let bronNum = 0
                    $.ajax({
                        url: "{{ route('sector1.deleteRecord') }}",
                        type: 'DELETE',
                        data: {
                            ids: ids,
                            _token: $('meta[name="csrf-token"]').attr('content')
...
@endsection
@section('header_title', 'Участок №1')

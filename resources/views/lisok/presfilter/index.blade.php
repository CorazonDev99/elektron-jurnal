        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'solution', name: 'presfilter.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'presfilter.responsible_person', sClass: 'dt-center'},
        ...
        $('#familiarizationButton').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/presfilter/success-records',
                        type: 'POST',
                        data: {
                            ids: ids,

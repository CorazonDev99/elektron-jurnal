        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'rmu.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'rmu.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'rmu.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'rmu.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'rmu.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'rmu.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'rmu.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'rmu.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'rmu.reason', sClass: 'dt-center'},
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('rmu.updateAcknowledgment') }}',
                            type: 'POST',

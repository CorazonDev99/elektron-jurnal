        ...
        $(document).ready(function () {
            ...
            var table = $('#lisok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'dc1.id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'dc1.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'dc1.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'dc1.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'dc1.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'dc1.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'dc1.employee_name', searchable: false, sClass: 'dt-center'},
                    {
                        data: null,
                        orderable: false,
                        searchable: false,

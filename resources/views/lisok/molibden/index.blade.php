        ...
        $(document).ready(function () {
            ...
            var table = $('#listok-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'id', name: 'molibden.id', searchable: false, visible: false},
                    {data: 'user_id', name: 'molibden.user_id', searchable: false, visible: false},
                    {data: 'created_at', name: 'created_at', sClass: 'dt-center', width: '70px'},
                    {data: 'equipment', name: 'molibden.equipment', sClass: 'dt-center'},
                    {data: 'problem', name: 'molibden.problem', searchable: false, sClass: 'dt-center'},
                    {data: 'solution', name: 'molibden.solution', searchable: false, sClass: 'dt-center'},
                    {data: 'responsible_person', name: 'molibden.responsible_person', sClass: 'dt-center'},
                    ...
                    {data: 'resolved', name: 'molibden.resolved', sClass: 'dt-center'},
                    {data: 'employee_name', name: 'molibden.employee_name', searchable: false, sClass: 'dt-center'},
                    {data: 'reason', name: 'molibden.reason', sClass: 'dt-center'},
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '{{route('molibden.reasonRecord')}}',
                                    type: 'POST',
                                    data: formData,
                                    headers: {
                                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click', '#solved', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('molibden.updateAcknowledgment') }}',
                            type: 'POST',
        ...
        $('#deleteButton').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let bronNum = 0
                    $.ajax({
                        url: "{{ route('molibden.deleteRecord') }}",
                        type: 'DELETE',
                        data: {
                            ids: ids,
                            _token: $('meta[name="csrf-token"]').attr('content')
